...
urlpatterns = patterns('',
    ...
    url(r'^child/$', views.ChildList.as_view()),
    url(r'^child/(?P<pk>[0-9]+)/$', views.ChildDetail.as_view()),
    url(r'^reward/$', views.RewardList.as_view()),
    url(r'^reward/(?P<pk>[0-9]+)/$', views.RewardDetail.as_view()),    
)
